...
public class GameAssetPaths {
    ...
    // Animations
    public static final String PLAYER_EAST_SLASH = "factorydude/animations/player/playerEastSlash.png";
    public static final String PLAYER_EAST_WALK = "factorydude/animations/player/playerEastWalk.png";
    public static final String PLAYER_NORTH_SLASH = "factorydude/animations/player/playerNorthSlash.png";
    ...
    public static final String PLAYER_SLASH = "factorydude/animations/player/playerSlash.png";
    ...
    public static final String CURSOR_FRAMES = "factorydude/animations/crosshair.png";
    // Fonts
